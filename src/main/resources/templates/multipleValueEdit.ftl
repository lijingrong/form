<ul class="nav nav-tabs" id="myTab" role="tablist">
    ...
    <li class="nav-item">
        <a class="nav-link" id="componentData-tab" data-toggle="tab" href="#componentData" role="tab"
           aria-controls="componentData" aria-selected="false">数据</a>
    </li>
</ul>
<div class="tab-content" id="myTabContent">
    ...
    <div class="tab-pane fade" id="componentData" role="tabpanel" aria-labelledby="componentData-tab">
